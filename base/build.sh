...
wget -O /tmp/alpine@ma.ssive.co-5b44d911.rsa.pub https://alpine.ma.ssive.co/alpine@ma.ssive.co-5b44d911.rsa.pub
install -Dm644 /tmp/alpine@ma.ssive.co-5b44d911.rsa.pub /mnt/target/etc/apk/keys/alpine@ma.ssive.co-5b44d911.rsa.pub

cat > /mnt/target/etc/apk/repositories <<-EOF
http://dl-cdn.alpinelinux.org/alpine/v3.8/main

https://alpine.ma.ssive.co/stable
https://alpine.ma.ssive.co/testing
EOF
